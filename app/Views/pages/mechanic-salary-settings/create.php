    ...
    <!-- <div class="page-title">
        <div class="row">
            <div class="col-12 col-md-6 order-md-1 order-last">
                <h3>Tambah Pengaturan Gaji Mekanik</h3>
                <p class="text-subtitle text-muted">Atur persentase komisi untuk layanan mekanik</p>
            </div>
    ...
    <section class="section">
        <div class="card">
            <div class="card-header">
                <h4 class="card-title">Formulir Pengaturan Gaji Baru</h4>
            </div>
            <div class="card-body">
                ...
                <form action="<?= base_url('settings/mechanic-salaries/save') ?>" method="post" class="form form-horizontal">
                    <?= csrf_field() ?>
                    <div class="form-body">
                        <div class="row">
                            <div class="col-md-4">
                            ...
                            <div class="col-md-8 form-group">
                                <input type="number" id="percentage" class="form-control" name="percentage" 
                                       placeholder="Masukkan persentase" value="<?= old('percentage') ?>" 
